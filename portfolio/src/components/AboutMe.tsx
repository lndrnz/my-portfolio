...
const AboutMe = () => {
  return (
    <div id="aboutme" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16">
      ...
      <p className="text-left py-4 text-base font-normal text-stone-500">
        ...
        <p className="text-left py-4 text-base font-normal text-stone-500"> I enjoy transforming abstract ideas into tangible,
